...
##'
##' Title, P.O., Bemmels, J.B. 2016. ENVIREM: An expanded set of bioclimatic and topographic variables increases flexibility and improves performance of ecological niche modeling. bioRxiv doi: XXXXXXX.
##' 
##' @details
##' 
##' Package: envirem\cr
